...
/**
 * @method ConditionalBuilder and(string $name, string $operator, string|null $value)
 * @method ConditionalBuilder or(string $name, string $operator, string|null $value)
 */
